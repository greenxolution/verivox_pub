...
Unit test class for `ERPIntegrationService` that tests the `updateVacationBalance` method. This unit test will use the `HttpCalloutMock` interface to mock the HTTP response from the ERP system.
